...
5${getBankServiceClassCode()}${setLength(cbank.custrecord_2663_legal_name,16)}                    ${setLength(cbank.custpage_eft_custrecord_2663_issuer_num,10)}CCDPayment   ${pfa.custrecord_2663_process_date?string("yyMMdd")}${pfa.custrecord_2663_process_date?string("yyMMdd")}   1${setLength(cbank.custpage_eft_custrecord_2663_processor_code,4)}${setLength(cbank.custpage_eft_custrecord_2663_bank_code,4)}${setPadding(batchCount,"left","0",7)}
    <#assign recordCount = recordCount + 1>
